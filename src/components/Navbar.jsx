...
<div class=" flex items-center gap-10 -translate-x-8 py-3 px-2 ">
    <div>
    <button class="w-[200px] hover-w-[300px] transition-all duration-300 text-sm  hover:text-indigo-700 border-2 border-blue-300  py-1 rounded-xl mt-2 flex justify-center items-center bg-white font-semibold">
